      ...
      <div className="mb-6 flex flex-col items-start justify-between gap-2 py-2">
        ...
        >
          <input
            ...
            {...register("remember")}
          />
          <span className="mr-2.5 inline-flex h-5.5 w-5.5 items-center justify-center rounded-md border border-stroke bg-white peer-checked:border-primary peer-checked:bg-primary dark:border-dark-3 dark:bg-white/5">
            <svg
              width="10"
              height="7"
              viewBox="0 0 10 7"
            ...
            >
              <path
                d="M9.707 0.293a1 1 0 0 1 0 1.414l-5 5a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L4.5 4.086l4.293-4.293a1 1 0 0 1 1.414 0Z"
                fill="currentColor"
              />
            </svg>
          </span>
        ...
        <Link
          ...
          className="font-medium text-dark underline duration-300 hover:text-primary dark:text-white dark:hover:text-primary"
        >
          Mot de passe oublié ?
        </Link>
      </div>
